...
PYTHON_REQUIREMENTS="awscli~=1.15.0 boto3~=1.7.0 cmd2~=0.8.0 git+git://github.com/arcivanov/docker-squash@docker_rebase git+ssh://git@github.com/Traiana/nex-daemon"
